...
export function Footer() {
  ...
  return (
    <footer className="site-footer">
      ...
      <div className="footer-bottom"><span>© 2026 {property.name}. Tous droits réservés.</span><div><Link to="/mentions-legales#mentions">Mentions légales</Link><Link to="/mentions-legales#confidentialite">Confidentialité</Link><Link to="/mentions-legales#cgv">CGV</Link></div></div>
    </footer>
  );
}
