...
export function Footer() {
  return (
    <footer className="site-footer">
      ...
      <div className="footer-bottom"><span>© 2026 Hôtel Rivage. Tous droits réservés.</span><div><Link to="/mentions-legales">Mentions légales</Link><a href="#">Confidentialité</a><a href="#">CGV</a></div></div>
    </footer>
  );
}
